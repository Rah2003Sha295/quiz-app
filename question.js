const questions = [
  {
    ...
    options: ["Data structure and algorithms", "Data service agent", "Data sender agent", "none of these"],
  ...
  },
  {
    ...
    options: ["Linear data structure", "Non-Linear data structure", "All of above", "None of These"],
  ...
  {
    question: "What is the time complexity of searching for an element in a binary search tree (BST) with n nodes in the worst case?",
    options: ["O(1)", "O(log n)", "o(n)", "o(n^2)"],
    answer: "o(log n)"
  },
  {
    question: "What is the purpose of the heapify operation in a heap data structure?",
    options: ["To add a new element to the heap", "To remove the root element from the heap", "To convert an array into a heap", "To sort the elements in the heap"],
    answer: "To convert an array into a heap"
  },
  {
    question: "What is the space complexity of an algorithm?",
    options: ["The amount of memory required by the algorithm", "The time taken by the algorithm to run", "The number of operations performed by the algorithm", "The number of comparisons made by the algorithm"],
  ...
  },
  {
    ...
    options: [" Input from the console", " Output to the console", "Conditional statement", " Loop control"],
  ...
  },
  {
    ...
    options: ["Output to the console", "Input from the console", "Conditional statement", "Loop control"],
  ...
  },
  {
    ...
    options: ["Size of a variable", "Address of a variable", "Type of a variable", "Value of a variable"],
  ...
  },
  {
    ...
    options: ["Exits the function", " Declares the function", " Calls another function", "Jumps to a labeled statement"],
  ...
  },
  {
    name: "dbms",
        ...
        options: ["Atomicity, Consistency, Isolation, Durability", "Association, Concurrency, Integrity, Durability", " Authorization, Concurrency, Inheritance, Dependency", "Atomicity, Concurrency, Indexing, Dependency"],
        answer: " Atomicity, Consistency, Isolation, Durability"
      },
      {
        question: "Which of the following is not a type of database model?",
        options: ["Relational Database Model", " NoSQL Database Model", "Object-Oriented Database Model", "Structured Query Language Database Model"],
        answer: "Structured Query Language Database Model"
      },
      {
        question: "What is a primary key in a relational database?",
        options: ["A key used for encryption", " A unique identifier for a record in a table", "A key used for sorting records", "A foreign key in another table"],
      ...
      },
      {
        ...
        options: ["Insert data into a table", "Update existing records", "Retrieve data from one or more tables", "Delete records from a table"],
      ...
      },
      {
        ...
        options: ["A key used for accessing remote databases", "A key used for encryption", "A key that references the primary key in another table", "A key that uniquely identifies a record in a table"],
      ...
      },
      {
        ...
        options: ["Simple Query Language", "Structured Question Language", " Standard Query Language", "Sequential Query Language"],
        answer: "Standard Query Language"
      },
      {
        question: "In the context of database transactions, what does isolation refer to?",
        options: ["Ensuring that transactions are executed in the correct order", "Protecting the database from unauthorized access", "The ability of transactions to be executed concurrently without interference", "Ensuring that transactions are permanently saved in the database"],
        answer: "The ability of transactions to be executed concurrently without interference"
      },
      {
        name:"wd",
            question: "What does HTML stand for in web development?",
            options: ["Hyper Text Makeup Language", " Hyperlink and Text Markup Language", "Hyper Transfer Markup Language", "Hyper Text Markup Language"],
            answer: "Hyper Text Markup Language"
          },
          {
            question: "Which CSS property is used to control the space between the elements' content and its border?",
            options: ["margin", " padding", "border-spacing", "space-around"],
            answer: " padding"
          },
          {
            question: "What is the purpose of JavaScript in web development?",
            options: ["Styling web pages", "Creating dynamic content and interactivity", "Defining webpage structure", "Specifying webpage layout"],
          ...
          },
          {
            ...
            options: ["Creating visually appealing designs", "Designing for a specific browser", "Designing websites that adapt to different screen sizes", "Designing with a focus on graphics"],
          ...
          },
          {
            ...
            options: ["Margin, Border, Padding, Content", "Header, Body, Footer", "Width, Height, Depth", "Background, Font, Color"],
            answer: "Margin, Border, Padding, Content"
          },
          {
            question: "What is the purpose of the jQuery library in web development?",
            options: ["Styling web pages", " Server-side scripting", "DOM manipulation and event handling", "Database management"],
          ...
          },
          {
            ...
            options: ["Controls the order of elements in the HTML", "Specifies the font size", "Determines the stacking order of positioned elements", "Defines the color of text"],
...
function endQuiz() {
  ...
  quizContainer.innerHTML = `<h2>Quiz ended! Your score is ${score} out of ${questions.length}</h2>`;
}
// Set the quiz duration in seconds
const quizDuration = 60; // 1 minutes
...
function startTimer() {
    ...
    const timerInterval = setInterval(() => {
        ...
        if (timeLeft < 0) {
            ...
            alert('Time is up!'); // You can customize this action
        } else {
            updateTimer();
        }
